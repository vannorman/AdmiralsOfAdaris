...
{
    public class AAGameManager : MonoBehaviourPunCallbacks
    {
        public static AAGameManager Instance = null;
        ...
        public string sceneToLoadOnDisconnect = "DemoAsteroids-LobbyScene";
        public GameObject localPlayer;
        private void StartGame()
        {
            Debug.Log("Hm");
            var start = PhotonNetwork.LocalPlayer.GetPlayerNumber() == 0 ? startingPosition1 : startingPosition2;

            //PhotonNetwork.Instantiate("PUNPlayer", start.position, start.rotation, 0);
            localPlayer.transform.position = start.position;
            localPlayer.transform.rotation = start.rotation;
            localPlayer.GetComponent<TeamIdentifier>().color = PhotonNetwork.LocalPlayer.GetPlayerNumber() == 0 ? Constants.TeamColor.Red : Constants.TeamColor.Blue;
